...
- P001 -> C001 | ReAct: Synergizing Reasoning and Acting in Language Models | ICLR 2023 | verified
- P002 -> C001 | Toolformer: Language Models Can Teach Themselves to Use Tools | NeurIPS 2023 | verified
- P003 -> C002 | Retrieval-Augmented Generation for Knowledge-Intensive NLP Tasks | NeurIPS 2020 | verified
- P004 -> C002 | SelfCheckGPT: Zero-Resource Black-Box Hallucination Detection for Generative Large Language Models | EMNLP 2023 | verified
- P005 -> C004 | AgentBench: Evaluating LLMs as Agents | ICLR 2024 | verified
- P006 -> C004 | Reflexion: Language Agents with Verbal Reinforcement Learning | NeurIPS 2023 | verified
- P007 -> C005 | Self-Refine: Iterative Refinement with Self-Feedback | NeurIPS 2023 | verified
